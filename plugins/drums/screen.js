...
function createFactory() {
    ...
    function _teardown() {
        ...
        if (_highwayCanvas) {
            _highwayCanvas.style.visibility = _prevHighwayVisibility;
            _highwayCanvas = null;
            _prevHighwayVisibility = '';
        }
    ...
    const instance = {
        init(canvas /* , bundle */) {
            ...
            _prevHighwayVisibility = canvas ? canvas.style.visibility : '';
